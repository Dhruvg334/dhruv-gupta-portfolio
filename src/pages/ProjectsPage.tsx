        ...
        <div className="shell">
          ...
          >
            ...
            <p className="page-subtitle">
              Comprehensive technical case studies spanning Industrial GraphRAG, AI-agent security scanners, source-grounded learning platforms, and deterministic capacity-aware planning.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="section projects-catalog-section">
        <div className="shell">
          ...
          <div className="filter-pills-bar" role="tablist">
            {[
              { id: 'all', label: 'All Architectures (5)' },
              { id: 'graph', label: 'Industrial GraphRAG' },
              { id: 'safety', label: 'Agent Security & Gatekeeper' },
              { id: 'eval', label: 'Learning & Evaluation Suite' },
          ...
          <div className="projects-catalog-grid">
            {filteredProjects.map((p) => (
              <motion.article key={p.id} className="catalog-project-card" {...reveal}>
