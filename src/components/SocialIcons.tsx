...
export function DevpostMark({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M0 3.6 3.6 0h16.8L24 3.6v16.8L20.4 24H3.6L0 20.4V3.6zm4.8 3.6v9.6h4.8c3.2 0 5.4-1.8 5.4-4.8s-2.2-4.8-5.4-4.8H4.8zm3 2.4h1.8c1.8 0 3 1 3 2.4s-1.2 2.4-3 2.4H7.8V9.6z" />
    </svg>
  )
}
